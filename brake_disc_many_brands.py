...
def post_fetching(brand_name,model_name,type_name,n_list,p_list,c_list):
    ...
    for i in range(len(n_list)):
            final_list.append([current_model_name[i], car_type[i],"Breake disc" ,n_list[i], p_list[i], c_list[i]])
...
def reach_path():
    #start = 1
    brand_list = ['SEAT', 'SKODA', 'TOYOTA', 'VOLVO', 'VW', 'APOLLO', 'ARO', 'ARTEGA', 'ASIA MOTORS', 'ASTON MARTIN', 'AUDI', 'AUSTIN', 
